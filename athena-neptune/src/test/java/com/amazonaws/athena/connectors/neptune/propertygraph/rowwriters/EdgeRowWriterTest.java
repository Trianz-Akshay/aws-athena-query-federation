...
class EdgeRowWriterTest {
    ...
    void testBitField() {
        ...
        EdgeRowWriter.writeRowTemplate(mockBuilder, field, configOptions);
    ...
    void testIdField() {
        ...
        Map<String, Object> context = new HashMap<>();
        context.put(T.id.toString(), "edge-123");
        
        Map<String, Object> inVertex = new LinkedHashMap<>();
        inVertex.put(T.id.toString(), "vertex-in-123");
        context.put(Direction.IN.toString(), inVertex);
        
        Map<String, Object> outVertex = new LinkedHashMap<>();
        outVertex.put(T.id.toString(), "vertex-out-123");
        context.put(Direction.OUT.toString(), outVertex);
    ...
    @Test
    void testInVertexField() {
        Field field = new Field("in", FieldType.nullable(new ArrowType.Utf8()), Collections.emptyList());
        Map<String, Object> context = new HashMap<>();
        Map<String, Object> inVertex = new LinkedHashMap<>();
        inVertex.put(T.id.toString(), "vertex-in-123");
        context.put(Direction.IN.toString(), inVertex);
        ...
        EdgeRowWriter.writeRowTemplate(mockBuilder, field, configOptions);
        verify(mockBuilder).withExtractor(eq("in"), any());
    }

    @Test
    void testOutVertexField() {
        Field field = new Field("out", FieldType.nullable(new ArrowType.Utf8()), Collections.emptyList());
        Map<String, Object> context = new HashMap<>();
        Map<String, Object> outVertex = new LinkedHashMap<>();
        outVertex.put(T.id.toString(), "vertex-out-123");
        context.put(Direction.OUT.toString(), outVertex);
        ...
        EdgeRowWriter.writeRowTemplate(mockBuilder, field, configOptions);
        verify(mockBuilder).withExtractor(eq("out"), any());
    }
