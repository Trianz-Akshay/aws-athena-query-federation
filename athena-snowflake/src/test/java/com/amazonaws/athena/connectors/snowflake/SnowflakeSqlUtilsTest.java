...
public class SnowflakeSqlUtilsTest
{
    ...
    public void buildSql_WithEmptySchema_GeneratesQueryWithNull()
    {
        ...
        String sql = SnowflakeSqlUtils.buildSql(tableName, emptySchema, constraints, split, parameterValues);
    ...
    @Test
    public void quote_WithIdentifier_ReturnsQuotedIdentifier()
    {
    ...
    @Test
    public void quote_WithQuotesInIdentifier_EscapesQuotes()
    {
    ...
    @Test
    public void singleQuote_WithString_ReturnsQuotedString()
    {
    ...
    @Test
    public void singleQuote_WithQuotesInString_EscapesQuotes()
    {
    ...
    {
        List<TypeAndValue> parameterValues = new ArrayList<>();
        String sql = SnowflakeSqlUtils.buildSql(tableName, schema, constraints, split, parameterValues);
