...
public class SqlServerCredentialsProvider extends OAuthCredentialsProvider
{
    ...
    public SqlServerCredentialsProvider(String secretName)
    {
        super(secretName);
    }

    @VisibleForTesting
    public SqlServerCredentialsProvider(String secretName, SecretsManagerClient secretsClient, HttpClient httpClient)
    {
