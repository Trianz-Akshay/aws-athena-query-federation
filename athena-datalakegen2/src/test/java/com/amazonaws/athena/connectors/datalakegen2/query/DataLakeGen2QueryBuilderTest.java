...
public class DataLakeGen2QueryBuilderTest
{
    ...
    private DataLakeGen2QueryFactory queryFactory;
    ...
    public void setUp()
    {
        queryFactory = new DataLakeGen2QueryFactory();
    ...
    {
        DataLakeGen2QueryBuilder builder = queryFactory.createQueryBuilder();
    ...
    {
        // DataLakeGen2 does not support LIMIT, so limit clause should be empty
    ...
    public void build_WithAllComponents_GeneratesCompleteQuery()
    {
        ...
        DataLakeGen2QueryBuilder builder = queryFactory.createQueryBuilder();
        builder.withCatalog(null); // DataLakeGen2 doesn't use catalog
        builder.withProjection(testSchema, split);
        builder.withTableName(TEST_TABLE);
        builder.withOrderByClause(constraints);
        builder.withLimitClause(constraints);
    ...
    public void getLimitClause_WithLimit_ReturnsEmptyLimitClause()
    {
        ...
        assertNotNull("Limit clause should not be null", limitClause);
        assertEquals("Limit clause should be empty string", "", limitClause);
    }
