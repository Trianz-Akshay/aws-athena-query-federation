...
public class DataLakeRecordHandlerTest
{
            ...
            throws Exception
    {
        ...
        this.dataLakeGen2RecordHandler = new DataLakeGen2RecordHandler(databaseConnectionConfig, amazonS3, secretsManager, athena, jdbcConnectionFactory, com.google.common.collect.ImmutableMap.of());
    }
            ...
            throws SQLException
    {
        ...
        // Verify that prepareStatement was called and parameters were set correctly
        Mockito.verify(this.connection, Mockito.times(1)).prepareStatement(Mockito.anyString());
