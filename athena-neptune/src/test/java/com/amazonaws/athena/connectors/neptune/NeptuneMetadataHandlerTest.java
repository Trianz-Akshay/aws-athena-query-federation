...
// Explicitly import classes from TestBase if they are not being inherited correctly
import com.amazonaws.athena.connectors.neptune.TestBase;
import com.amazonaws.athena.connectors.neptune.TestNeptuneConnection;
import static com.amazonaws.athena.connectors.neptune.TestBase.IDENTITY;
import static com.amazonaws.athena.connectors.neptune.TestBase.DEFAULT_CATALOG;
...
public class NeptuneMetadataHandlerTest extends TestBase {
    ...
    public void setUp() {
        ...
        glue = mock(GlueClient.class, withSettings().lenient());
    ...
    private void setupQueryPassthroughTest(String graphType, String query) throws Exception {
    ...
    public void testDoGetQueryPassthroughSchema_rdf_validSparql() throws Exception {
        setupQueryPassthroughTest("rdf", "SELECT ?s ?p ?o WHERE { ?s ?p ?o }");
    ...
    public void testDoGetQueryPassthroughSchema_rdf_invalidSparql() throws Exception {
        setupQueryPassthroughTest("rdf", "INVALID SPARQL QUERY");
    ...
    public void testDoGetQueryPassthroughSchema_propertyGraph_emptyResponse() throws Exception {
        setupQueryPassthroughTest("propertygraph", "g.V().hasLabel('nonexistent').valueMap().limit(1)");
    ...
    private GetTableRequest createPassthroughRequest(String query) {
        ...
        passthroughArgs.put(NeptuneQueryPassthrough.QUERY, query);
