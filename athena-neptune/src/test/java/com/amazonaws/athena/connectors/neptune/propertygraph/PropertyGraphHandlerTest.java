...
class PropertyGraphHandlerTest {
    ...
    void setUp() {
        ...
        Constraints constraints = new Constraints(constraintsMap, Collections.emptyList(), Collections.emptyList(), 0);
    ...
    @Test
    void testViewQueryWithInvalidSchema() throws Exception {
    ...
    @Test
    void testQueryPassthroughWithInvalidQuery() throws Exception {
