...
public class RowWritersComprehensiveTest {
    ...
    @Test
    public void testVertexRowWriter_BitExtractor_ValidBoolean() throws Exception {
    ...
    @Test
    public void testVertexRowWriter_BitExtractor_ValidFalse() throws Exception {
        ArrayList<Object> boolValues = new ArrayList<>();
    ...
    @Test
    public void testVertexRowWriter_VarCharExtractor_MultipleValues() throws Exception {
    ...
    @Test
    public void testVertexRowWriter_VarCharExtractor_SpecialIDField() throws Exception {
    ...
    @Test
    public void testVertexRowWriter_DateMilliExtractor_ValidDate() throws Exception {
    ...
    @Test
    public void testVertexRowWriter_IntExtractor_ValidInteger() throws Exception {
    ...
    @Test
    public void testVertexRowWriter_BigIntExtractor_ValidLong() throws Exception {
    ...
    @Test
    public void testVertexRowWriter_Float4Extractor_ValidFloat() throws Exception {
    ...
    @Test
    public void testVertexRowWriter_Float8Extractor_ValidDouble() throws Exception {
    ...
    // EdgeRowWriter Tests (simplified to avoid Direction issues)
    @Test
    public void testEdgeRowWriter_BitExtractor_ValidBoolean() throws Exception {
    ...
    @Test
    public void testEdgeRowWriter_VarCharExtractor_ValidString() throws Exception {
    ...
    @Test
    public void testEdgeRowWriter_DateMilliExtractor_ValidDate() throws Exception {
        Date testDate = new Date();
    ...
    @Test
    public void testEdgeRowWriter_IntExtractor_ValidInteger() throws Exception {
    ...
    @Test
    public void testEdgeRowWriter_Float8Extractor_ValidDouble() throws Exception {
    ...
    @Test
    public void testCustomSchemaRowWriter_BitExtractor_ValidBoolean() throws Exception {
    ...
    @Test
    public void testCustomSchemaRowWriter_VarCharExtractor_ValidString() throws Exception {
    ...
    @Test
    public void testCustomSchemaRowWriter_DateMilliExtractor_ValidDate() throws Exception {
        Date testDate = new Date();
    ...
    @Test
    public void testCustomSchemaRowWriter_IntExtractor_ValidInteger() throws Exception {
    ...
    @Test
    public void testCustomSchemaRowWriter_BigIntExtractor_ValidLong() throws Exception {
    ...
    @Test
    public void testCustomSchemaRowWriter_Float4Extractor_ValidFloat() throws Exception {
    ...
    @Test
    public void testCustomSchemaRowWriter_Float8Extractor_ValidDouble() throws Exception {
    ...
    // Test case sensitivity configurations
    @Test
    public void testVertexRowWriter_CaseInsensitive() throws Exception {
    ...
    @Test
    public void testEdgeRowWriter_CaseSensitive() throws Exception {
    ...
    @Test
    public void testCustomSchemaRowWriter_DefaultCaseInsensitive() throws Exception {
    ...
    @Test
    public void testVertexRowWriter_NullValues() throws Exception {
    ...
    @Test
    public void testEdgeRowWriter_EmptyStringValues() throws Exception {
    ...
    @Test
    public void testCustomSchemaRowWriter_EmptyStringValues() throws Exception {
