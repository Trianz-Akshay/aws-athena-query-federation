...
public class RDFHandlerTest extends TestBase {
    ...
    public void testExecuteQueryWithInvalidQueryMode() throws Exception {
        Schema schema = SchemaBuilder.newBuilder()
            .addMetadata("schema.querymode", "invalid")
            .addMetadata("schema.type", "invalid")
            .addStringField("s")
            .build();
    ...
    public void testExecuteQueryWithMissingClassUri() throws Exception {
        Schema schema = SchemaBuilder.newBuilder()
            .addMetadata("schema.querymode", "class")
            .addMetadata("schema.predsPrefix", "ex")
            .addMetadata("schema.subject", "person")
            .addMetadata("schema.type", "class")
            .addStringField("person")
            .build();
    ...
    private Schema createRDFSchema() {
        ...
        metadata.put("schema.type", "sparql");
