...
/**
 * Factory for creating Snowflake query builders with StringTemplate support.
 */
public class SnowflakeQueryFactory extends JdbcQueryFactory
{
    ...
    public SnowflakeQueryBuilder createQueryBuilder()
    {
        return new SnowflakeQueryBuilder(getQueryTemplate(SnowflakeQueryBuilder.getTemplateName()));
    }
}
