...
import com.amazonaws.athena.connectors.teradata.query.TeradataQueryBuilder;
 ...
 */
public class TeradataSqlUtils
{
    private static final TeradataQueryFactory queryFactory = new TeradataQueryFactory();

    private TeradataSqlUtils()
    {
    }
     ...
     *
     * @return The TeradataQueryFactory instance
     */
    public static TeradataQueryFactory getQueryFactory()
    {
        return queryFactory;
    }
     ...
     * Teradata using StringTemplate approach.
     *
     * @param catalogName The catalog name (database name), may be null.
     ...
     */
    public static String buildSql(String catalogName, TableName tableName, Schema schema, Constraints constraints,
            Split split, List<TypeAndValue> parameterValues)
    {
        TeradataQueryBuilder queryBuilder = queryFactory.createQueryBuilder();
